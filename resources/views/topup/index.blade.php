...
<div class="bg-gray-100 py-10">
    <div class="max-w-2xl mx-auto bg-white p-6 shadow-md rounded-lg">
        ...
        <input type="hidden" id="quantity" value="1" min="1" class="border rounded px-3 py-1 w-16">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.card').forEach(card => {
            card.addEventListener('click', function() {
                document.querySelectorAll('.card').forEach(c => c.classList.remove('bg-blue-500', 'text-white', '-rotate-2', 'scale-105'));
